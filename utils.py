...
def extract_actions(response: str, observation_type: str, action_space: str, masks: list = None) -> list:
    """
    ...
    if observation_type in ["screenshot", "a11y_tree", "screenshot_a11y_tree"]:
        if action_space == "computer_13":
            ...
            raise ValueError(f"Invalid action space: {action_space}") # FIXME; instead of ValueError log_to_self
